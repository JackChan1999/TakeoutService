        ...
        switch (i) {
            case 0:
                list.add(new GoodsInfo(sellerId * 1000 + 1, "肉末烧汁茄子+千叶豆腐套餐(含粗粮米饭)",
                        ConstantValue.HOST + "/TakeoutService/imgs/goods/caiping_taocan.webp",
            ...
            case 1:
                list.add(new GoodsInfo(sellerId * 1000 + 6, "纯手工馒头(一个)",
                        ConstantValue.HOST + "/TakeoutService/imgs/goods/mantou.webp", "", 54,
                        true, false, 1.5f, 0));
                list.add(new GoodsInfo(sellerId * 1000 + 7, "粗粮米饭",
                        ConstantValue.HOST + "/TakeoutService/imgs/goods/culiangmifan.webp", "",
                        43, true, false, 2, 0));
                list.add(new GoodsInfo(sellerId * 1000 + 8, "黄金玉米饼(一个)",
                        ConstantValue.HOST + "/TakeoutService/imgs/goods/huangjinyumibing.webp",
                        "", 24, true, false, 3,
                        0));
                list.add(new GoodsInfo(sellerId * 1000 + 9, "粗粮菜团子(一个)",
                        ConstantValue.HOST + "/TakeoutService/imgs/goods/culiangcaituanzi.webp",
                        "", 10, true, false, 6,
                        0));
                break;
            case 2:
                list.add(new GoodsInfo(sellerId * 1000 + 11, "细品香肠",
                        ConstantValue.HOST + "/TakeoutService/imgs/goods/xipingxiangchang.webp",
                        "", 10, true, false, 10,
                        0));
                list.add(new GoodsInfo(sellerId * 1000 + 12, "蝴蝶翅",
                        ConstantValue.HOST + "/TakeoutService/imgs/goods/hudiechi.webp", "", 10,
                        true, false, 10, 0));
                list.add(new GoodsInfo(sellerId * 1000 + 13, "孜然鸡柳",
                        ConstantValue.HOST + "/TakeoutService/imgs/goods/ziranjiliu.webp", "",
                        10, true, false, 10, 0));
                list.add(new GoodsInfo(sellerId * 1000 + 14, "盐酥鸡",
                        ConstantValue.HOST + "/TakeoutService/imgs/goods/yansuji.webp", "", 10,
                        true, false, 10, 0));
                break;
            case 3:
                list.add(new GoodsInfo(sellerId * 1000 + 15, "放心-干烧带鱼套餐",
                        ConstantValue.HOST + "/TakeoutService/imgs/goods/caiping.webp",
            ...
            case 8:
                list.add(new GoodsInfo(sellerId * 1000 + 35, "四川泡菜",
                        ConstantValue.HOST + "/TakeoutService/imgs/goods/sichuanpaocai.webp", "",
                        53, true, false, 9, 0));
                list.add(new GoodsInfo(sellerId * 1000 + 36, "秘制萝卜条",
                        ConstantValue.HOST + "/TakeoutService/imgs/goods/mizhiluobutiao.webp", "", 53, true, false, 9, 0));
                list.add(new GoodsInfo(sellerId * 1000 + 37, "开胃黄瓜",
                        ConstantValue.HOST + "/TakeoutService/imgs/goods/kaiweihuanggua.webp", "", 53, true, false, 9, 0));
                break;
            case 9:
                list.add(new GoodsInfo(sellerId * 1000 + 38, "汇源果汁",
                        ConstantValue.HOST + "/TakeoutService/imgs/goods/huiyuan.webp", "", 53, true, false, 3, 0));
                list.add(new GoodsInfo(sellerId * 1000 + 35, "蒙牛酸牛奶",
                        ConstantValue.HOST + "/TakeoutService/imgs/goods/mengniusuanniunai.webp", "", 53, true, false, 3,
                        0));
                list.add(new GoodsInfo(sellerId * 1000 + 36, "红罐王老吉",
                        ConstantValue.HOST + "/TakeoutService/imgs/goods/wanglaoji.webp", "", 53, true, false, 5, 0));
                list.add(new GoodsInfo(sellerId * 1000 + 37, "可口可乐",
                        ConstantValue.HOST + "/TakeoutService/imgs/goods/kekoukele.webp", "", 53, true, false, 5, 0));
                list.add(new GoodsInfo(sellerId * 1000 + 38, "脉动",
                        ConstantValue.HOST + "/TakeoutService/imgs/goods/maidong.webp", "", 53, true, false, 6, 0));
                list.add(new GoodsInfo(sellerId * 1000 + 39, "雀巢丝滑拿铁",
                        ConstantValue.HOST + "/TakeoutService/imgs/goods/quechao.webp", "", 53, true, false, 6, 0));
                break;
            case 10:
                list.add(new GoodsInfo(sellerId * 1000 + 40, "产品",
                        ConstantValue.HOST + "/TakeoutService/imgs/goods/caiping.webp", "", 53, true, false, 0, 0));
                list.add(new GoodsInfo(sellerId * 1000 + 41, "加工中心1",
                        ConstantValue.HOST + "/TakeoutService/imgs/goods/jiagongzhongxin1.webp", "", 53, true, false, 0,
                        0));
                list.add(new GoodsInfo(sellerId * 1000 + 42, "加工中心2",
                        ConstantValue.HOST + "/TakeoutService/imgs/goods/jiagongzhongxin2.webp", "", 53, true, false, 0,
                        0));
                list.add(new GoodsInfo(sellerId * 1000 + 43, "加工中心3",
                        ConstantValue.HOST + "/TakeoutService/imgs/goods/jiagongzhongxin1.webp", "", 53, true, false, 0,
                        0));
                list.add(new GoodsInfo(sellerId * 1000 + 44, "加工中心4",
                        ConstantValue.HOST + "/TakeoutService/imgs/goods/jiagongzhongxin4.webp", "", 53, true, false, 0,
                        0));
                list.add(new GoodsInfo(sellerId * 1000 + 45, "加工中心5",
                        ConstantValue.HOST + "/TakeoutService/imgs/goods/jiagongzhongxin5.webp", "", 53, true, false, 0,
                        0));
                break;
        }
    }
